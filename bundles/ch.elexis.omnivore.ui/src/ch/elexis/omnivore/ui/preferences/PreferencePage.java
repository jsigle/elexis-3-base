...
public class PreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	//separatem Dr¸cken des Buttons "Anwenden" speichern (lˆst das nachfolgende performApply aus).
	//Der direkt neben diesem liegend Button "Standardwerte wiederherstellen" hingegen setzt
	//*alle* dar¸berliegenden Felder zur¸ck, aber nicht die beiden vorgenannten checkboxes...
	//Das ist beides sehr inkonsequent und kontra-intuitiv. Tats‰chlich m¸sste der Button
	//"Anwenden und Schliessen" auch die gew‰hlten Einstellungen der beiden checkboxes
	//ganz unten mit erfassen. Leider leider leider finde ich mal wieder nicht in endlicher
	//Zeit heraus, wo nun die Funktionalit‰t dieses Buttons implementiert ist - oder wie man
	//sie auf die beiden ¸brigen checkboxes ausdehnt. Vermutlich steht das wieder in einem
	//ganz anderen File f¸r eine ganz andere Klasse etc. - darum mˆge das bitte upstream richten.
	//P.S.: Nicht mal mit einer Suche nach "Anwenden und Schlie" ¸ber alle Files finde ich auch
	//nur den Text dieses Buttons, das d¸rfte also ein Stock button eines Standarddialogs sein -
	//und somit auch dessen Funktion "irgendwo" definiert, vielleicht auch mehrere Generationen
	//weiter oben, und w‰re hier mittels irgendeines Overrides zu erweitern...
	@Override
